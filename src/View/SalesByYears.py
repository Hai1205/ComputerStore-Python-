# Form implementation generated from reading ui file 'SalesByYears.ui'
#
...
class Ui_SalesByYears(object):
    def setupUi(self, SalesByYears):
        SalesByYears.setObjectName("SalesByYears")
        SalesByYears.resize(1163, 768)
        font = QtGui.QFont()
        font.setPointSize(13)
        SalesByYears.setFont(font)
        self.centralwidget = QtWidgets.QWidget(parent=SalesByYears)
        ...
        SalesByYears.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=SalesByYears)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1163, 26))
        self.menubar.setObjectName("menubar")
        SalesByYears.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=SalesByYears)
        self.statusbar.setObjectName("statusbar")
        SalesByYears.setStatusBar(self.statusbar)

        self.retranslateUi(SalesByYears)
        QtCore.QMetaObject.connectSlotsByName(SalesByYears)

    def retranslateUi(self, SalesByYears):
        _translate = QtCore.QCoreApplication.translate
        SalesByYears.setWindowTitle(_translate("SalesByYears", "MainWindow"))
        self.label.setText(_translate("SalesByYears", "Sales by years"))
        self.label_2.setText(_translate("SalesByYears", "Total cost:"))
        self.management.setText(_translate("SalesByYears", "Management"))
        self.statistics.setText(_translate("SalesByYears", "Stastistics"))
        self.signOut.setText(_translate("SalesByYears", "Sign out"))
        self.salesByYears.setText(_translate("SalesByYears", "Sales by years"))
        self.salesByEmployees.setText(_translate("SalesByYears", "Sales by employees"))
        self.salesByProducts.setText(_translate("SalesByYears", "Sales by products"))
        self.spendsByYears.setText(_translate("SalesByYears", "Spends by years"))
        self.spendsBySuppliers.setText(_translate("SalesByYears", "Spends by suppliers"))
        self.spendsByProducts.setText(_translate("SalesByYears", "Spends by products"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SalesByYears = QtWidgets.QMainWindow()
    ui = Ui_SalesByYears()
    ui.setupUi(SalesByYears)
    SalesByYears.show()
    sys.exit(app.exec())
