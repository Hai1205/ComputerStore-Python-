...
class Ui_Screen(object):
    def setupUi(self, Screen):
        ...
        Screen.resize(1163, 768)
        font = QtGui.QFont()
        font.setPointSize(13)
        Screen.setFont(font)
        self.centralwidget = QtWidgets.QWidget(parent=Screen)
        ...
        self.scan = QtWidgets.QLineEdit(parent=self.frame)
        self.scan.setObjectName("scan")
        self.gridLayout.addWidget(self.scan, 2, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=self.frame)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 0, 0, 1, 1)
        self.resolution = QtWidgets.QLineEdit(parent=self.frame)
        self.resolution.setObjectName("resolution")
        self.gridLayout.addWidget(self.resolution, 5, 1, 1, 1)
        ...
        self.panel = QtWidgets.QLineEdit(parent=self.frame)
        self.panel.setObjectName("panel")
        self.gridLayout.addWidget(self.panel, 4, 1, 1, 1)
        ...
        self.frame_6.setGeometry(QtCore.QRect(210, 530, 501, 81))
        ...
        self.menubar = QtWidgets.QMenuBar(parent=Screen)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1163, 26))
        self.menubar.setObjectName("menubar")
        Screen.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=Screen)
    ...
    def retranslateUi(self, Screen):
        ...
        self.clear.setText(_translate("Screen", "Clear"))
        self.management.setText(_translate("Screen", "Management"))
        self.statistic.setText(_translate("Screen", "Stastistics"))
        self.signOut.setText(_translate("Screen", "Sign out"))
        self.product.setText(_translate("Screen", "Product"))
        self.import_2.setText(_translate("Screen", "Import"))
        self.customer.setText(_translate("Screen", "Customer"))
        self.supplier.setText(_translate("Screen", "Supplier"))
        self.warranty.setText(_translate("Screen", "Warranty"))
        self.invoice.setText(_translate("Screen", "Invoice"))
        self.employee.setText(_translate("Screen", "Employee"))
        self.account.setText(_translate("Screen", "Account"))
