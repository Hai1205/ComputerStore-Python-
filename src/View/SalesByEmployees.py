# Form implementation generated from reading ui file 'SalesByEmployees.ui'
#
...
class Ui_SalesByEmployees(object):
    def setupUi(self, SalesByEmployees):
        SalesByEmployees.setObjectName("SalesByEmployees")
        SalesByEmployees.resize(1163, 768)
        font = QtGui.QFont()
        font.setPointSize(13)
        SalesByEmployees.setFont(font)
        self.centralwidget = QtWidgets.QWidget(parent=SalesByEmployees)
        ...
        self.message.setGeometry(QtCore.QRect(34, 70, 851, 31))
        ...
        SalesByEmployees.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=SalesByEmployees)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1163, 26))
        self.menubar.setObjectName("menubar")
        SalesByEmployees.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=SalesByEmployees)
        self.statusbar.setObjectName("statusbar")
        SalesByEmployees.setStatusBar(self.statusbar)

        self.retranslateUi(SalesByEmployees)
        QtCore.QMetaObject.connectSlotsByName(SalesByEmployees)

    def retranslateUi(self, SalesByEmployees):
        _translate = QtCore.QCoreApplication.translate
        SalesByEmployees.setWindowTitle(_translate("SalesByEmployees", "MainWindow"))
        self.label.setText(_translate("SalesByEmployees", "Sales by employees"))
        self.label_2.setText(_translate("SalesByEmployees", "Total cost:"))
        item = self.table.horizontalHeaderItem(0)
        item.setText(_translate("SalesByEmployees", "EmployeeID"))
        item = self.table.horizontalHeaderItem(1)
        item.setText(_translate("SalesByEmployees", "Employee name"))
        item = self.table.horizontalHeaderItem(2)
        item.setText(_translate("SalesByEmployees", "Cost"))
        item = self.table.horizontalHeaderItem(3)
        item.setText(_translate("SalesByEmployees", "Number of invoice"))
        self.message.setText(_translate("SalesByEmployees", "Statistics are taken from the beginning of the year until the present time."))
        self.management.setText(_translate("SalesByEmployees", "Management"))
        self.statistics.setText(_translate("SalesByEmployees", "Stastistics"))
        self.signOut.setText(_translate("SalesByEmployees", "Sign out"))
        self.salesByYears.setText(_translate("SalesByEmployees", "Sales by years"))
        self.salesByEmployees.setText(_translate("SalesByEmployees", "Sales by employees"))
        self.salesByProducts.setText(_translate("SalesByEmployees", "Sales by products"))
        self.spendsByYears.setText(_translate("SalesByEmployees", "Spends by years"))
        self.spendsBySuppliers.setText(_translate("SalesByEmployees", "Spends by suppliers"))
        self.spendsByProducts.setText(_translate("SalesByEmployees", "Spends by products"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SalesByEmployees = QtWidgets.QMainWindow()
    ui = Ui_SalesByEmployees()
    ui.setupUi(SalesByEmployees)
    SalesByEmployees.show()
    sys.exit(app.exec())
