...
class Ui_Keyboard(object):
    def setupUi(self, Keyboard):
        ...
        self.gridLayout.addWidget(self.LED, 3, 1, 1, 1)
        ...
        self.size_2 = QtWidgets.QLineEdit(parent=self.frame)
        self.size_2.setObjectName("size_2")
        self.gridLayout.addWidget(self.size_2, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Keyboard):
        ...
        self.label.setText(_translate("Keyboard", "Product detail - Keyboard"))
        self.label_5.setText(_translate("Keyboard", "LED"))
        self.label_4.setText(_translate("Keyboard", "Size"))
        ...
        self.label_10.setText(_translate("Keyboard", "Pin"))
