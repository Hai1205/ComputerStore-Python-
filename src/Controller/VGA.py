...
class VGA(QMainWindow):
    ...
    def update(self):
        detail = self.getDetail()
        self.pdd.updateVGA(detail["productID"], detail["MFG"], detail["cores"], detail["GPUclock"], detail["size"])

    def clear(self):
        self.ui.MFG.clear()
        self.ui.cores.clear()
        self.ui.GPUclock.clear()
        self.ui.size.clear()
