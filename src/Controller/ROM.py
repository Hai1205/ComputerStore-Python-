...
class ROM(QMainWindow):
    ...
    def update(self):
        detail = self.getDetail()
        self.pdd.updateROM(detail["productID"], detail["MFG"], detail["capacity"], detail["type"], detail["writeSpeed"], detail["readSpeed"])

    def clear(self):
        self.ui.MFG.clear()
        self.ui.capacity.clear()
        self.ui.type.clear()
        self.ui.writeSpeed.clear()
        self.ui.readSpeed.clear()
    ...
    def showData(self):
        ...
        self.ui.writeSpeed.setText(detail["writeSpeed"])
        self.ui.readSpeed.setText(detail["readSpeed"])